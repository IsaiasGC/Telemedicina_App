                  ...
                  child: Card(
                    ...
                    child: Container(
                          ...
                          child: ListTile(
                            ...
                            leading: Container(
                              padding: historial[index]['backdrop_path']!=null ? EdgeInsets.only(right: 5.0) : EdgeInsets.symmetric(horizontal: 27.0),
                              // decoration: BoxDecoration(
                              //   border: Border( right: BorderSide(width: 1.0, color: Colors.black))
                              // ),
                              child: historial[index]['backdrop_path']!=null ? Image.network("https://image.tmdb.org/t/p/w500"+historial[index]['backdrop_path'],) : Icon(Icons.photo, size: 50.00, color: Theme.of(context).textTheme.bodyText1.color,),
                            ),
                            title: Text(
                            ...
                            subtitle: Row(
                              children: <Widget>[
                                ...
                                Text(historial[index]['release_date'], style: Theme.of(context).textTheme.bodyText2)
                              ],
                            ),
